...
- **2026-08-25** (`3e3c127`) — Outstanding work split into four independent feature branches (scene/build-settings fix, Photon PUN2 migration, accountless quickplay, git history cleanup) instead of piling onto one branch. This file (`REVIVAL.md`) added.
